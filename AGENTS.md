...
│
├── internal/webui/assets/ # GENERATED by stage-web.sh; COMPILED INTO the binary
│                           # by go:embed. Never edit or commit -- edit the
│                           # files above and re-run stage-web.sh.
│                           # (1.7.5 moved this from ./web, which used to be a
│                           #  directory shipped BESIDE the binary. That made
│                           #  the app two artifacts a user could update
│                           #  separately, and they did: a new page beside an
│                           #  old server, with nothing able to say so.)
│
