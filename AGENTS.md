...
| **privacy & telemetry** | **STRICT ZERO TELEMETRY INVARIANT**: No usage analytics or prompt telemetry in public code. Private mirroring experiments (e.g. `echo-user`) must remain isolated in local/private development. |
