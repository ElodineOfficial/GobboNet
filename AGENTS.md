...
```
gobbonet/
├── chat.html              # Frontend shell — 950 lines; loads the modules below
...
│
├── launch.bat             # Orchestrator — 2,257 lines
│                           # Password setup, hardware probe, model download, health monitoring
├── fileserver.ps1         # Web server + reverse proxy — 1,967 lines
...
No build step, no module system, no framework. `chat.html` is a 950-line shell
...
### `fileserver.ps1` — Web server + proxy (1,967 lines)
