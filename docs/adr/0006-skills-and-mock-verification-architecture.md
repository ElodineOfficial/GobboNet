...
4. Enforce a **Strict Zero-Telemetry Invariant**: All experimental operator profiling and heuristic mirroring (`skills/echo-user/`) remain strictly isolated within local development environments and private forks, never exported to public upstream code.
